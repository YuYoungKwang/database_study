...
VALUES (T_ITEM_LIST_PK_SEQ.nextval, '아이템2', 10000, SYSDATE);

INSERT INTO T_ITEM_LIST (no, item_name, price)
VALUES (T_ITEM_LIST_PK_SEQ.nextval, '아이템3', 15000);

select * from T_ITEM_LIST;

INSERT INTO T_ITEM_LIST
VALUES (T_ITEM_LIST_PK_SEQ.nextval, '아이템4', 20000, null);

INSERT INTO T_ITEM_LIST
VALUES (T_ITEM_LIST_PK_SEQ.nextval, '아이템5', 25000, TO_DATE('2021-09-11'));
